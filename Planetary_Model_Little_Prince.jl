...
# ╔═╡ 3ddcfc40-9288-4d07-93db-309859a0cf18
md"""
### Planetary Model - Little Prince
"""
...
begin
	...
	g_earth = StandardAccelerationOfGravitation	
...
# ╔═╡ 04e1918c-044a-43ae-9015-6a75c5f5ed87
g.(R)

# ╔═╡ 174a3119-072d-4c1e-963a-964bd8420db4
# Now making a graph of the gravity x distance 

plot(R, g.(R), c=:purple, label = "Gravidade conforme distancia no planeta", 
xlabel = "Distance", 
ylabel = "Gravidade",
grid = true)

# ╔═╡ b156b72b-8560-4056-8698-785deea46b86
savefig("gravity.png")
